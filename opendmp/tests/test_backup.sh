...
#./ndmjob.`./distro.sh` -d6 -c -D localhost/4m,ndmp,ndmp -F /boot -T localhost/4m,ndmp,ndmp -f /dev/nst0 -I opendmp.idx
./ndmjob.`./distro.sh` -c -D localhost/4m,ndmp,ndmp -F /tmp -T localhost/4m,ndmp,ndmp -f /dev/nst0 -I centos.idx
